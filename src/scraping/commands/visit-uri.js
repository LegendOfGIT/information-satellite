...
module.exports = (context = {}, parameters = {}) => new Promise(resolve => {
    ...
    return httpClient({ url: commandParameters.uri, method: 'GET', headers: { 'Accept': undefined, 'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.90 Safari/537.36' }})
        .then(response => {
