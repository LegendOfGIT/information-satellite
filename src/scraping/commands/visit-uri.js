...
module.exports = (context = {}, parameters = {}) => new Promise(resolve => {
    ...
    return httpClient({ url: commandParameters.uri, method: 'GET', headers: { 'user-agent': generateString(8), 'host': 'www.amazon.de', pragma: 'no-cache', 'upgrade-insecure-requests': 1 }})
        .then(response => {
